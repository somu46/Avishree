...
const StatsSection = () => {
  ...
  const stats = [
    ...
    { id: 2, title: 'Events Organized', count: 500 },
    { id: 3, title: 'Happy Clients', count: 800 },
    { id: 4, title: 'Trained Employees', count: 200 },
  ];

  return (
    <section className="bg-gray-100 py-12 hidden lg:flex" ref={ref}>
      <div className="container mx-auto text-center">
        <h2 className="text-3xl font-semibold mb-6">Our Number That Speaks</h2>
        <div className="flex flex-row justify-center items-center gap-12 max-w-screen m-3 my-5">
          {stats.map((stat) => (
