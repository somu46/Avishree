...
const Ofiice = () => {
  return (
    <div className="w-full lg:w-auto lg:m-5 mx-auto flex justify-center pt-10 h-[50vh] lg:h-auto">
      <iframe
        ...
        className="w-full h-full rounded-lg shadow-md transition-transform transform hover:scale-105 border-2 border-yellow-500"
        allowFullScreen=""
        loading="lazy"
